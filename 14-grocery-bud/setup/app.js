...
function addItem(e) {
  ...
  if (value !== "" && !editFlag) {
    ...
    displayAlert('element added', 'success');
    ...
    displayAlert('input correct value', 'danger');
  }
}


// Alert Message Function with setTimeout
